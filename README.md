...
graph TD
    ...
    D --> D1[مقارنة المحاضرة الأخيرة بكل ما سبقها]
    D --> D2[طابور المراسلة الذكي بنقرة واحدة]
```

---

### 1. 🎯 رادار التسرب والمتابعة المبكرة (At-Risk Students Radar)
...
### 2. 📴 تقنية العمل الكامل بدون إنترنت (Offline-First PWA Architecture)
...
### 3. 🤖 محرك الذكاء الاصطناعي (Google Gemini AI Engine)
...
### 4. 👥 نظام تسليم واستلام الطلاب المتطور (Student Transfer System)
- **أنماط تسليم متعددة:**
...
### 5. 📜 محرر الشهادات التفاعلي بالسحب والإفلات (Visual Certificate Studio)
...
### 6. 🔔 مركز التنبيهات الفورية (Push Notification Center)
...
### 7. 🎯 العرض التعريفي والدليل التفاعلي الشامل (Presentation & Guide App)
